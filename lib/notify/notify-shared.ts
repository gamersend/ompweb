...
export type NotifyKind = "agent_end" | "approval" | "error" | "guardrail" | "scheduler" | "delegation" | "digest";

export const NOTIFY_KINDS: readonly NotifyKind[] = ["agent_end", "approval", "error", "guardrail", "scheduler", "delegation", "digest"];
